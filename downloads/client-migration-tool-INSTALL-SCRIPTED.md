...
[client-migration-tool-INSTALL-MANUAL.md](https://pingidentity.github.io/cloud-migration/downloads/client-migration-tool-INSTALL-MANUAL.md). Use that doc instead if you need to
...
- Manual Installation Instructions (if you are on a non-linux/mac platform) - [client-migration-tool-INSTALL-MANUAL.md](https://pingidentity.github.io/cloud-migration/downloads/client-migration-tool-INSTALL-MANUAL.md)
